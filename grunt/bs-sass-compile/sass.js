  ...
  grunt.config.merge({
    sass: {
      ...
      extras: {
        options: options,
        files: {
          'static/css/<%= pkg.name %>-flex.css': 'scss/<%= pkg.name %>-flex.scss',
          'static/css/<%= pkg.name %>-grid.css': 'scss/<%= pkg.name %>-grid.scss',
          'static/css/<%= pkg.name %>-reboot.css': 'scss/<%= pkg.name %>-reboot.scss'
        }
      },
      docs: {
        options: options,
